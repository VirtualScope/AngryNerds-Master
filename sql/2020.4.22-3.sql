...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2020 at 01:57 AM
...
(3, 'ICS-325-D', 'Chemistry is the scientific discipline involved with elements and compounds composed of atoms, molecules and ions.', 'Chemistry.png'),
(8, 'ICS-325-R', 'Chemistry is the scientific discipline involved with elements and compounds composed of atoms, molecules and ions.', 'microscope-ocular-lenses.jpg'),
(9, 'ICS-325-B', 'Psychology is the scientific study of the mind and behavior, according to the American Psychological Association. Psychology is a multifaceted discipline and includes many sub-fields of study such are', 'biology.png'),
(11, 'ICS-897-BA', 'Construction is the process of constructing a building or infrastructure. Construction differs from manufacturing in that manufacturing typically involves mass production of similar items without a de', 'construction.jpg');
...
(1, 'Johnny', 'Appleseed', 'someone@example.com', 'abc123', 1, '2020-04-22 20:08:58', 'yes', 'Just some guy with a lot of work to do.');
...
(5, 'The Dark Knight Rises', 'It has been eight years since Batman (Christian Bale), in collusion with Commissioner Gordon (Gary Oldman), vanished into the night. Assuming responsibility for the death of Harvey Dent, Batman sacrificed everything for what he and Gordon hoped would be the greater good.', '2020-04-22 17:00:41', 1, 1, 'Psych.png'),
(6, 'Super Tuesday', 'Super Tuesday is the United States presidential primary election day in February or March when the greatest number of U.S. states hold primary elections and caucuses. Approximately one-third of all delegates to the presidential nominating conventions can be won on Super Tuesday, more than on any other day.', '2020-04-22 17:03:18', 1, 1, 'Psych.png'),
(7, 'The Dark Knight Rises', 'It has been eight years since Batman (Christian Bale), in collusion with Commissioner Gordon (Gary Oldman), vanished into the night. Assuming responsibility for the death of Harvey Dent, Batman sacrificed everything for what he and Gordon hoped would be the greater good.', '2020-04-22 18:26:31', 1, 3, ''),
(8, 'Super Tuesday', 'Super Tuesday is the United States presidential primary election day in February or March when the greatest number of U.S. states hold primary elections and caucuses. Approximately one-third of all delegates to the presidential nominating conventions can be won on Super Tuesday, more than on any other day.', '2020-04-22 18:29:04', 1, 3, 'Psych.png'),
(9, 'Construction', 'Construction is the process of constructing a building or infrastructure. Construction differs from manufacturing in that manufacturing typically involves mass production of similar items without a designated purchaser, while construction typically takes place on location for a known client.', '2020-04-22 18:31:50', 1, 9, 'construction.jpg'),
(10, 'Test', 'Test', '2020-04-22 18:49:29', 1, 9, 'construction.jpg');
