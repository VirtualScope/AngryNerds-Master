        ...
        <div class="col-12 order-md-1">
            <form class="needs-validation" novalidate="" method="post" id="myForm" enctype="multipart/form-data">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="ClassCode" name="ClassCode" placeholder="" <?php echo "value='" . $code . "'" ?> required="">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="textarea" class="form-control" rows="5" id="ClassDescription" name="ClassDescription" placeholder="" <?php echo "value='" . $description . "'" ?> required=""></input>
                        <div class="invalid-feedback">
